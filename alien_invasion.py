...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        """since we have create a multiple rows of aliens, following code have no use now"""
    ...
    def _change_fleet_direction(self):
        """ Drop the entore fleet and change the fleet's direction"""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
        ...
        # Draw teh play button if the screen is inactive.
